StartupEvents.registry('item', event => {
    ...
    event.create('rotten_apple')
        ...
        .texture('kubejs:item/food/rotten_apple')
        .food(f => {
            f
                .hunger(3)
                .saturation(0.3)
    ...
    event.create('strange_meat')
        ...
        .texture('kubejs:item/food/strange_meat')
        .food(f => {
            f
                .hunger(3)
                .saturation(0.4)
    ...
    event.create('human_finger_cheese')
        ...
        .texture('kubejs:item/food/human_finger_cheese')
        .food(f => {
            f
                .hunger(7)
                .saturation(0.4)
    ...
    event.create('hairy_finger')
        ...
        .texture('kubejs:item/food/hairy_finger')
        .food(f => {
            f
                .hunger(3)
                .saturation(0.4)
    ...
    event.create('moldy_bread')
        ...
        .texture('kubejs:item/food/moldy_bread')
        .food(f => {
            f
                .hunger(4)
                .saturation(0.5)
    ...
    event.create('soggy_cracker')
        ...
        .texture('kubejs:item/food/soggy_cracker')
        .food(f => {
            f
                .hunger(1)
                .saturation(0.4)
    ...
    //     .texture('kubejs:item/food/finger_cheese_fondue')
    //     .food(f => {
    //         f
    //             .hunger(7)
    //             .saturation(0.9)
    ...
    //     .texture('kubejs:item/food/ratatouille_a_la_rat')
    //     .food(f => {
    //         f
    //             .hunger(8)
    //             .saturation(0.8)
    ...
    event.create('canned_beans')
        ...
        .texture('kubejs:item/food/canned_beans')
        .food(f => {
            f
                .hunger(6)
                .saturation(0.4)
    ...
    event.create('canned_fish')
        ...
        .texture('kubejs:item/food/canned_fish')
        .food(f => {
            f
                .hunger(6)
                .saturation(0.5)
    ...
    event.create('canned_noodles')
        ...
        .texture('kubejs:item/food/canned_noodles')
        .food(f => {
            f
                .hunger(5)
                .saturation(0.6)
    ...
    event.create('fried_roaches')
        ...
        .texture('kubejs:item/food/fried_roaches')
        .food(f => {
            f
                .hunger(2)
                .saturation(0.3)
    ...
    event.create('chewy_brain')
        ...
        .texture('kubejs:item/food/chewy_brain')
        .food(f => {
            f
                .hunger(4)
                .saturation(0.4)
    ...
    event.create('eye_candy')
        ...
        .texture('kubejs:item/food/eye_candy')
        .food(f => {
            f
                .hunger(2)
                .saturation(0.5)
    ...
    event.create('strange_meat_jerky')
        ...
        .texture('kubejs:item/food/strange_meat_jerky')
        .food(f => {
            f
                .hunger(5)
                .saturation(0.6)
